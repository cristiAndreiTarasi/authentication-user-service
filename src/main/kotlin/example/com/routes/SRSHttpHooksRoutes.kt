...
fun handleOnUnpublish(payload: SrsHookPayload): Boolean {
    ...
    println("on_unpublish: ${payload.stream}")
    return true
}

fun handleOnPlay(payload: SrsHookPayload): Boolean {
    // Handle stream play logic
    println("on_play: ${payload.stream}")
    return true
}

fun handleOnStop(payload: SrsHookPayload): Boolean {
    // Handle stream stop logic
